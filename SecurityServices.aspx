<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="SecurityServices.aspx.cs" Inherits="InfrastructureManagement.SecurityServices" %>
                                        ...
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlTypeOfService" CssClass="form-control" runat="server">
