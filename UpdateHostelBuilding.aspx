<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateHostelBuilding.aspx.cs" Inherits="InfrastructureManagement.UpdateHostelBuilding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="HostelBuilding" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle">
                                                ...
                                                <div class="col-md-6 contact-info">
                                                    <div class="container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtHostelFireSafetyValidUpTo" max="9999-12-31" Type="date" CssClass="form-control ajax__calendar_body" runat="server"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group">
